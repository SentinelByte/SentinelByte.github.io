...
image: /assets/images/terraform-security-best-practice.jpg
---
...
2. [Use Least Privilege IAM for Terraform](#use-least-privilege-iam-for-terraform)  
3. [Secure Terraform State Files](#secure-terraform-state-files)  
4. [Scan Terraform Code for Vulnerabilities](#scan-terraform-code-for-vulnerabilities)  
5. [Isolate Environments](#isolate-environments)  
6. [Never Hardcode Secrets](#never-hardcode-secrets)  
7. [Harden Your Terraform Modules](#harden-your-terraform-modules)  
8. [Review Changes Before Applying](#review-changes-before-applying)  
9. [Final Thoughts](#final-thoughts)  
10. [Related Posts](#related-posts)  
